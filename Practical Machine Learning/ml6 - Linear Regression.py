...
# save classifier model as pickle file
with open('linearregression.pickle','wb') as f:
    pickle.dump(clf, f)

# load classifier model from pickle file
# in practice you would not both save and load the pickle everytime this script is run; the classifier would only be trained every so often, at which point the pickle file containing it would be updated
